        ...
        <div className=''>
          ...
          <div className='content card-grid '>
            {tempresult.map((value, index) => {
              // setBrand((prevBrand) => [...prevBrand, value.name]);
              return <Cards key={index} image={value.image} category={value.name} totalLike={value.price} title={value.name} link={value.link} />
            })}
          </div>
