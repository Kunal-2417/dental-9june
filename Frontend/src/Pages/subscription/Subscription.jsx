  ...
  const handleOpenRazorpay =  async (data) => {
    ...
    const options = {
        ...
        handler: function (response) {
            ...
            axios.post('http://localhost:3000/verfiy', { response: response })
                .then(res => {
                    console.log(res, "37")
    ...
    <div>
      <h1 className='heading'>
        ...
        <div className='cards silver'>
          ...
          <button className='button'> Free-Monthly</button>
        ...
        <div className='cards  borders'>
          ...
          <button className='button'> Silver-Monthly</button>
        ...
        <div className='cards borders'>
          ...
          <button className='button'> Gold-Monthly</button>
        ...
        <div className='main'>
          <div><h1>Annually </h1>
        <div className='cards'>
          <div className='details silver'>
            <b className='free'>Free</b>
            <p>1 Question per day</p>
            <p>Price: <span className='symbol'> &#8377;0</span></p>
          </div>
          <button className='button'> Free-Annually</button>
          <button className='button' onClick={handleFree}>BUY NOW</button>
        </div>
        ...
        <div className='cards  borders'>
          ...
          <button className='button'> Silver-Annually</button>
          <button className='button'onClick={() => handlePayment(100)}>BUY NOW</button>
        </div>
        ...
        <div className='cards borders'>
          ...
          <button className='button'> Gold-Annually</button>
          <button className='button' onClick={() => handlePayment(1000)}>BUY NOW</button>
        </div>
        </div>
        </div>
